...
?>
  <tbody>
      <?php
       ...
       { ?>
    <tr >
      <th scope="row" class="px-5">   <?php echo  $comp['c_name'] ?></th>
      <td> <?php echo  $comp['arrive_year'] ?></td>
      <td> <a  href="/cruds/updatepastr.php?pastrid=<?php echo 2;?>"><button class="btn btn-primary"> Update</button></a></td>
      <td>  <button onclick="deletepastrid(<?php echo 2;?>)" class="btn btn-danger">Delete</button > </td>
