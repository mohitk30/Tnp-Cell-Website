...
$sql = "Select sfname as FirstName,slname as LastName,senrollno as EnrollNo,semail as Email,scyear as YearOfStudy,srslink as ResumeLink from $DB_TBLName where srslink !='';";
