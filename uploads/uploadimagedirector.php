<?php
  ...
  //	$image_text = mysqli_real_escape_string($db, $_POST['image_text']);
  	...
  	$target = "images/directorimage.png";
...
<title>Upload Director's Image</title>
<style type="text/css">
...
<div id="Form-uptpo" class="p-5 w-50 d-flex flex-row"> 
  ...
  <form method="POST" action="" enctype="multipart/form-data">
  	...
  	<div>
          <label for="image" class="form-label bold-label"> <strong>Chose Image of Director </strong> </label><br>
  	  <input class="inputfile btn btn-primary" id="fileinput" accept="image/png" type="file" name="image" required>
...
<div id="imagepreview" class="w-50 p-5">
    ...
    <img src="../images/directorimage.png" height="200px" width="200px">
