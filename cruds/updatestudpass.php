...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $query="UPDATE s_login SET logenroll='".$senroll."',logpassword='".$spass."' where logenroll='".$enrol."'";
...
<div class="input-group mb-3 mt-4">
         <span class="input-group-text">*Enroll No.</span>
          <input type="number" class="form-control" placeholder="Enroll No." value="<?php if(isset($slog['logenroll'])){echo $slog['logenroll'];}?>" name="seroll" aria-label="Username" required>
