...
$dbsadm=db_connect();
   ...
   if( $countsstd>0){
    ...
    echo "<table class=".$classt."><tr><td   class=".$class.">".$sstd['sfname']." ".$sstd['slname']."</td><td class=".$class.">".$sstd['senrollno']."</td><td class="."px-5"."><a  class=".$classbtn1." href=".$sstd['srslink'].">Update </a> </td><td class="."px-5"."><a  class=".$classbtn2." href=".$sstd['srslink'].">Delete </a> </td><td class="."px-5"."><a  class=".$classbtn3." href=".$sstd['srslink'].">Update password </a> </td><td class="."px-5"."><a  class=".$classbtn3." href=".$sstd['srslink'].">Update Placement info</a> </td> </tr></table>"; 
