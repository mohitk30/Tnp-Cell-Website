<?php
 ...
 $query="UPDATE admin_memb SET admusername='".$adupun."',admenroll='".$adupen."',admpassword='".$adupp."' where admid='".$admid."'";
...
<div class="mx-auto w-50 pt-5">
    ...
    <form  method="post" action="<?php
         ...
         <input type="number"  min="100000000" name="adenoup" class="form-control" value="<?=$admi['admenroll']?>"  id="inputeno" placeholder="Enrollment No." required>
        </div>
    ...
    <div class="form-group col-md-6 mt-2">
      ...
      <input type="password" class="form-control" id="inputupass" name="admpassup" value="<?=$admi['admpassword']?>" placeholder="Password" required>
    </div>
