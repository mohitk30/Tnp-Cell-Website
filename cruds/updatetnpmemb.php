...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $query="UPDATE tnp_memb SET tnpenroll='".$uptnproll."',tnppos='".$uptnppos."' where tnpid='".$uptnpid."'";
...
<div class="form-group col-md-6 mt-3">
    ...
    <input type="text" class="form-control" id="inputtnpmeno" name="tnpenrolup" value="<?=$tnpmi['tnpenroll']?>" placeholder="201210030" required>
  </div>
  <div class="form-group col-md-6 mt-3">
