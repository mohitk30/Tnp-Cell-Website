<?php
 ...
 $query="UPDATE reg_student SET rsyear='".$regyr."',rslink='".$reglnk."' where rsid='".$upregsid."'";
...
<form method="post"   action="<?php
 ...
 <input type="number"  min="201210030" name="regeno" class="form-control" disabled id="inputeno" value="<?=$regi['rsenroll']?>" placeholder="Enrollment No." required>
</div>
<div class="mb-3 col-md-4">
