...
//echo '<script>alert("Done")</script>';
         $dbadstud=db_connect();
          ...
          // $senroll=$_POST['seroll'];
           ...
           $query="UPDATE student SET sfname='".$sfname."',slname='".$slname."', sfathername='".$fname."',saddress='".$addres."',scountry='".$scountr."',sccgpa='".$scgpa."', spno='".$sphno."',semail='".$semal."',sbranch='".$sbranc."',sgender='".$sgentr."',scyear='".$scyear."',srslink='".$srlink."' where senrollno='".$roli."'";
  ...
  <div class="container-fluid nav-in-company">
    <span class="navbar-text fs-4 ">
      <!-- <a href="<?= $admlink ?>" class="text-decoration-underline"> Back</a>>   -->  Update Student  
    </span>
  </div>
</nav>
<section>
    ...
    <div class="input-group mb-3 mt-4">
         <span class="input-group-text">*Enroll No.</span>
          <input type="number" class="form-control" placeholder="Enroll No." disabled value="<?php if(isset($fstud['senrollno'])){echo $fstud['senrollno'];}?>" name="seroll" aria-label="Username" required>
          <span class=" mx-2"></span>
    ...
    <div class="input-group mb-3 mt-4">
          ...
          <input type="text" class="form-control" name="sadd" value="<?php if(isset($fstud['saddress'])){echo $fstud['saddress'];}?>" placeholder="Street, City, State" aria-label="Username"  >
