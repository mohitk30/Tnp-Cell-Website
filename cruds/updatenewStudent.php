...
<head>
    ...
    <title>New Student Register Form
</title>
</head>
...
//echo '<script>alert("Done")</script>';
         $dbadstud=db_connect();
           ...
           $query="UPDATE student SET sfname='".$sfname."',slname='".$slname."',senrollno='".$senroll."',sfathername='".$fname."',saddress='".$addres."',scountry='".$scountr."',sccgpa='".$scgpa."', spno='".$sphno."',semail='".$semal."',sbranch='".$sbranc."',sgender='".$sgentr."',scyear='".$scyear."',srslink='".$srlink."' where senrollno='".$roli."'";
  ...
  <div class="container-fluid nav-in-company">
    <span class="navbar-text fs-4 ">
      <!-- <a href="<?= $admlink ?>" class="text-decoration-underline"> Back</a>>   -->  New Student Registration
    </span>
  </div>
</nav>
<section>
