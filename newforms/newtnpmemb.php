...
<body>
  ...
  if($result_setreg){
    ...
    echo "Error in adding new member";
  }
...
<section>
  ...
  // echo $sre['onoff']=="on"?"":"Registrations are Closed"; ?></span></p>   -->
    ...
    <div class="form-group col-md-6 mt-3">
     <span class="pb-3 pt-2"> Add new Member's Details</span><br><br>
    <label  class="bold-label" for="inputtnpmeno"> Member enroll no  </label>
    <input type="text" class="form-control" id="inputtnpmeno" name="tnpenrol" placeholder="201210030" required>
  </div>
  <div class="form-group col-md-6 mt-3">
    <label  class="bold-label" for="inputAddress"> Position</label>
    <input type="text"  class="form-control" id="inputAddress" name="posi" placeholder="Student Head/Coordinator" required>
  </div>
