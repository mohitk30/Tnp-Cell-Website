...
//echo '<script>alert("Done")</script>';
         $dbadstud=db_connect();
           ...
           $query="INSERT INTO student(sfname,slname,senrollno,sfathername,saddress,scountry,sccgpa, spno,semail,sbranch,sgender,scyear,srslink)  VALUES('".$sfname."','".$slname."','".$senroll."','".$fname."','".$addres."','".$scountr."','".$scgpa."','".$sphno."','".$semal."','".$sbranc."','".$sgentr."','".$scyear."','".$srlink."')";
