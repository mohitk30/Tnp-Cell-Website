...
<body>
  ...
  if(isset($_POST['eno'])){
    ...
    //$dbs=db_connect();
     ...
     $query="INSERT INTO reg_student(rsenroll,rsyear,rslink) VALUES('".$senroll."','".$syear."','".$slink."')";
...
<section>
  ...
  <p > <span class="<?php echo $sre['onoff']=="on"?"green-color":"red-color"; ?>"> <?php echo $sre['onoff']=="on"?"":"Registrations are Closed"; ?></span></p>  
    ...
    <form method="post"   action="studentPlaceForm.php?roln=<?=$sroll;?>" id="register-student-form" >
   
    <div class="mb-3 col-md-4">
  <label for="inputeno" class="form-label bold-label">Enroll No.</label>
  <input type="number"  min="20121000" name="eno" class="form-control" value="<?=$sdata['senrollno'];?>"  id="inputeno" placeholder="Enrollment No." required>
</div>
<div class="mb-3 col-md-4">
