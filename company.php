...
$query="select count(*) as studcount, spspplacecomp,pstrname,pstrlink from sp_info left join pst_reuriter on spspplacecomp like pstrname where spspplacecomp is not null and spplacectc >'0'  group by  spspplacecomp ;";
...
?>
  ...
  <img class="card-img-top psr-image" src="<?=$pstr['pstrlink']?>" alt="<?=$pstr['spspplacecomp']?>">
  <div class="mt-3">
<span class="pt-2">Total Student Placed: <span class="bold-label"> <?=$pstr['studcount']?></span></span><br>
<span class="pt-2">Company Name:<span class="bold-label">  <?=$pstr['spspplacecomp']?></span></span>
  </div>
