...
<div id="top-nav-admin" class="d-flex flex-row " >
  <h4 class="p-4 mx-5 d-flex flex-row ">   Welcome &nbsp; <span class="light-green-text"> <?php echo $admin_username; ?>,</span></h4>
    ...
    <a class="ms-auto mx-5 mt-2" href="/checkadmin.php"><button class="btn admin-buttons log-out-btn "> <span class="fs-5   light-green-text"> <strong> Log out   </strong></span></button></a>
...
<?php
   ...
   $queryappdrive="SELECT * from drives where isapproved= 'yes'";
...
<div class="px-5 pt-2 mx-2 fromdirectorheadinf admin-buttons"> Dashboard</div>
    <div class="info-dash mx-auto d-flex flex-wrap " style="margin-top: 17px;">
        ...
        <div class="square-boxs">
        <span class="box-heading">
                Approved Drives   <br> <span class="counts"> <?=$countapprd;?></span>
            </span>
        </div>
        <div class="square-boxs">
        <span class="box-heading">
    ...
    <div class="w-100 pt-4 mx-auto">
      <a href="/views/tnpmemberslistdash.php">  <button class="btn admin-buttons mx-5 all-tnp-det"> <span class="fs-4 fw-bold"> Click here to view all Tnp members details</span></button></a>
...
<div class="px-5 pt-2 mx-2 fromdirectorheadinf admin-buttons"> Past Recruiters</div>
               ...
               <div class="w-100">
                ...
                <div class="pt-5"><span class="p-5 fs-4 mt-5"><strong>Total No. of past recruiters are 40</strong></span></div>
...
<div class="pt-5"><span class="p-5 fs-4 mt-1"><strong>Total No. of Upcoming/Approved Drives are <?=$countupdc?></strong></span></div>
...
<div id="admin-form" class="modal">
  ...
  <div class="modal-content m-content">
    <span class="close ms-auto">&times;</span>
     <div>
         <h5>Add new Admin Enroll , username and Password </h5>
         <form  method="post" action="<?php
                                        $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
                                        echo $actual_link;
                                        ?>">
         <div class="mb-3 col-md-6">
         <input type="number"  min="100000000" name="adeno" class="form-control"  id="inputeno" placeholder="Enrollment No." required>
        </div>
        <div class="form-group col-md-6 mt-2">
       
      <input type="text" class="form-control" id="inputuname" name="admuname" placeholder="Username" required>
    </div>
    <div class="form-group col-md-6 mt-2">
