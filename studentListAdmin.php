...
?>
  <tbody id="all-stud" >
    ...
    <tr id="" > 
      ...
      <td class="px-5"> <?php echo   $rstud['senrollno'] ; ?></td>
      <td class="px-5"> <a  class="btn btn-primary rlink-btn" href="cruds/updatenewStudent.php?rols=<?=$rstud['senrollno'] ?>">Update </a> </td>
      <td class="px-5"> <a  class="btn btn-danger rlink-btn" href="" onclick="deleteStudentid(<?php echo  $rstud['senrollno']; ?>)">  Delete </a> </td>
